...
public class Oscilacoes {
    private Double dia;
    @ShowOnTable(name = "Oscilação do Mês")
    private Double mes;
    @ShowOnTable(name = "Oscilação dos últimos 30 dias")
    private Double ultimos30Dias;
    @ShowOnTable(name = "Oscilação dos últimos 12 meses")
    private Double ultimos12Meses;
    @ShowOnTable(name = "Oscilação Ano 2015")
    private Double ano2015;
    @ShowOnTable(name = "Oscilação Ano 2014")
    private Double ano2014;
    @ShowOnTable(name = "Oscilação Ano 2013")
    private Double ano2013;
    @ShowOnTable(name = "Oscilação Ano 2012")
    private Double ano2012;
    @ShowOnTable(name = "Oscilação Ano 2011")
    private Double ano2011;
    @ShowOnTable(name = "Oscilação Ano 2010")
